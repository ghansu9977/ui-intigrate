...
<body>
        ...
        <div class="container">
            <div class="menu-bg-wrap w-100">
                <div class="site-navigation">
                    <a href="<?= \yii\helpers\Url::to(['site/index']) ?>" class="logo m-0 float-start">Property</a>

                    <ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu float-end">
                        <li class="active"><a href="<?= \yii\helpers\Url::to(['site/index']) ?>">Home</a></li>
                        <li class="has-children">
                            <a href="<?= \yii\helpers\Url::to(['site/properties']) ?>">Properties</a>
                            <ul class="dropdown">
                                <li><a href="<?= \yii\helpers\Url::to(['site/add-property']) ?>">Add Property</a></li>
                                <li><a href="<?= \yii\helpers\Url::to(['site/view-property']) ?>">View Property</a></li>
                                <!-- Uncomment if needed
              <li class="has-children">
                <a href="#">Dropdown</a>
                <ul class="dropdown">
              ...
              -->
                        ...
                        <li><?= \yii\helpers\Html::a('Login', \yii\helpers\Url::to(['user/login']), ['class' => 'nav-link']) ?>
                        </li>
                    </ul>
    ...
    <div class="hero">
        <div class="hero-slide">
            ...
            <div class="img overlay"
                style="background-image: url('<?= \Yii::getAlias('@web') ?>/images/hero_bg_3.jpg')"></div>
    ...
    <div class="container">
        <div class="row mb-5 align-items-center">
            ...
            <div class="col-lg-6 text-lg-end">
                <p>
                    <a href="<?= \yii\helpers\Url::to(['site/properties']) ?>" target="_blank" class="btn btn-primary text-white py-3 px-4">View all properties</a>
                </p>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <div class="property-slider-wrap">
                    <div class="property-slider">
                        <?php
                        $properties = [
                            ['image' => 'img_1.jpg', 'price' => '$1,291,000', 'address' => '5232 California Fake, Ave. 21BC', 'city' => 'California, USA', 'beds' => '2', 'baths' => '2'],
                            ['image' => 'img_2.jpg', 'price' => '$1,291,000', 'address' => '5232 California Fake, Ave. 21BC', 'city' => 'California, USA', 'beds' => '2', 'baths' => '2'],
                            // Add more properties here
                        ];
                        
                        foreach ($properties as $property) {
                            echo '<div class="property-item">';
                            echo '<a href="' . \yii\helpers\Url::to(['site/property-single']) . '" class="img">';
                            echo '<img src="' . \Yii::getAlias('@web') . '/images/' . $property['image'] . '" alt="Property Image" class="img-fluid">';
                            echo '</a>';
                            echo '<div class="property-content">';
                            echo '<div class="price mb-2"><span>' . $property['price'] . '</span></div>';
                            echo '<div>';
                            echo '<span class="d-block mb-2 text-black-50">' . $property['address'] . '</span>';
                            echo '<span class="city d-block mb-3">' . $property['city'] . '</span>';
                            echo '<div class="specs d-flex mb-4">';
                            echo '<span class="d-block d-flex align-items-center me-3">';
                            echo '<span class="icon-bed me-2"></span>';
                            echo '<span class="caption">' . $property['beds'] . ' beds</span>';
                            echo '</span>';
                            echo '<span class="d-block d-flex align-items-center">';
                            echo '<span class="icon-bath me-2"></span>';
                            echo '<span class="caption">' . $property['baths'] . ' baths</span>';
                            echo '</span>';
                            echo '</div>';
                            echo '<a href="' . \yii\helpers\Url::to(['site/property-single']) . '" class="btn btn-primary py-2 px-3">See details</a>';
                            echo '</div>';
                            echo '</div>';
                            echo '</div>';
                        }
    ...
    <div class="section section-5 bg-light" style="">
        <div class="container">
            <div class="row justify-content-center text-center mb-5">
